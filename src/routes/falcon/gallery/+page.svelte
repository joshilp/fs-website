<script lang="ts">
	...
	// Replace src/lib/assets/images/falcon/gallery/gallery-1.jpg through gallery-6.jpg with real photos
	import url1 from '$lib/assets/images/falcon/gallery/gallery-1.jpg';
	import url2 from '$lib/assets/images/falcon/gallery/gallery-2.jpg';
	import url3 from '$lib/assets/images/falcon/gallery/gallery-3.jpg';
	import url4 from '$lib/assets/images/falcon/gallery/gallery-4.jpg';
	import url5 from '$lib/assets/images/falcon/gallery/gallery-5.jpg';
	import url6 from '$lib/assets/images/falcon/gallery/gallery-6.jpg';
	import { ChevronLeft, ChevronRight, X } from 'lucide-svelte';
	import { properties } from '$lib/config.js';
	// CTA background — replace src/lib/assets/images/falcon/hero.jpg to change this photo
	import ctaBg from '$lib/assets/images/falcon/hero.jpg';
	...
	const photos = [
		...
		{ url: url6, alt: 'Outdoor pool at Falcon Resort, Osoyoos BC' },
		{ url: url3, alt: 'Wide view of Osoyoos Lake beach with boats anchored near shore, South Okanagan BC' },
		{ url: url2, alt: 'Outdoor pool with Osoyoos Lake and mountains in the background' },
		{ url: url4, alt: 'Resort exterior with Okanagan mountains behind, Osoyoos BC' }
	];
...
<svelte:head>
	<title>Falcon Resort Photos | Osoyoos BC — Beach, Pool &amp; Grounds</title>
	<meta
		name="description"
		content="Photos of Falcon Resort in Osoyoos, BC — Osoyoos Lake beach, outdoor pool, and resort grounds. Lakeside motel on Main Street."
	/>
	<meta property="og:title" content="Falcon Resort Photos | Osoyoos BC" />
	<meta property="og:description" content="See the beach, pool, and grounds at Falcon Resort in Osoyoos, BC." />
	<meta property="og:type" content="website" />
	<meta property="og:url" content="https://falcon-spanish.com/falcon/gallery" />
</svelte:head>
...
<section class="pt-10 pb-6 text-center">
	<div class="mx-auto max-w-2xl px-6">
		...
		<h1 class="font-serif text-5xl font-bold text-resort-dark">Photos & Gallery</h1>
		<p class="mt-4 font-sans text-lg text-resort-dark/65">
			A look at the beach, pool, and grounds — Osoyoos Lake right at your door.
		</p>
	</div>
</section>
...
<section class="mx-auto max-w-6xl px-6 py-16">
	<div class="columns-1 gap-3 sm:columns-2 lg:columns-3">
		{#each photos as photo, i}
			<button
				class="group mb-3 block w-full cursor-zoom-in overflow-hidden rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-resort-stone focus-visible:ring-offset-2"
				onclick={() => openPhoto(i)}
...
<section class="relative overflow-hidden py-16 text-center text-white">
	<!-- Background: replace src/lib/assets/images/falcon/hero.jpg to change this photo -->
	<img
		src={ctaBg}
		alt=""
		aria-hidden="true"

<script lang="ts">
	...
	const photos = [
		...
		{ src: gallery6, alt: 'Outdoor pool at Falcon Resort, Osoyoos BC' },
		{ src: gallery3, alt: 'Wide view of Osoyoos Lake beach with boats anchored near shore, South Okanagan BC' },
		{ src: gallery2, alt: 'Outdoor pool with Osoyoos Lake and mountains in the background' },
		{ src: gallery4, alt: 'Resort exterior with Okanagan mountains behind, Osoyoos BC' }
	];
